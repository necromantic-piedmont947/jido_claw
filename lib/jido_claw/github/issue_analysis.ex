defmodule JidoClaw.GitHub.IssueAnalysis do
  ...
  actions do
    ...
    create :create do
      primary? true
      accept [:issue_number, :repo_full_name, :classification, :confidence, :triage_data, :research_data, :pr_data, :status, :project_id]
    end
    ...
    read :by_issue do
      ...
      filter expr(repo_full_name == ^arg(:repo_full_name) and issue_number == ^arg(:issue_number))
    end
  end
