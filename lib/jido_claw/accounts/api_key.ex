defmodule JidoClaw.Accounts.ApiKey do
  ...
  actions do
    ...
    create :create do
      ...
      change {AshAuthentication.Strategy.ApiKey.GenerateApiKey, prefix: :jidoclaw, hash: :api_key_hash}
    end
  ...
  calculations do
    calculate :valid, :boolean, expr(is_nil(revoked_at) and (is_nil(expires_at) or expires_at > now()))
  end
